...
const Background = forwardRef<SVGStopElement, BackgroundProps>(
  ({ offset }, ref): JSX.Element => (
    <svg className="speed-background" width={286} height={55} viewBox="0 0 286 55" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
